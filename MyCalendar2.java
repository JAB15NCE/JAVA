...
public class MyCalendar2 {
   ...
   //This will display a top portion ASCII art which should be a Pyrimid that is scaleable
      for (int line = 1; line <=SIZE; line++) {
         for (int zero =1; zero <= (-4 * line + 4 * SIZE); zero++)
            System.out.print("00");    
      
         for (int equal = 1; equal <= (8 * line - 8); equal++) {
            System.out.print("==");     
         } 
      ...
      //creates the user overall menu with the ability to interact with the menu code. 
